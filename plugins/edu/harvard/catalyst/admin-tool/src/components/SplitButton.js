...
export const SplitButton = ({optionsList, handleClick, customActionsBtnOption}) => {
    ...
    const handleOpenMenuItemClick = (event, index) => {
                                ...
                                <MenuList id="split-button-menu" autoFocusItem>
                                    {optionsList.map((option, index) => (
                                        <MenuItem
                                            ...
                                            onClick={(event) => handleOpenMenuItemClick(event, index)}
                                        >
                                            {option}
                                        </MenuItem>
                                    ))}
