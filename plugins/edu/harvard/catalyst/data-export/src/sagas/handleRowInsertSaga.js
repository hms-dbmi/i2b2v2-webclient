...
const parseTermInfoXml = (termXml) => {
    ...
    let valueMetadataXml = termXml.getElementsByTagName('metadataxml');
    let hivesList = [];
    valueMetadataXml.map(item => {
    })
