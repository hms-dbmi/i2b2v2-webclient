...
// TODO: move this into a view controller?
            ...
            switch (newMode) {
                case "Patients":
                    if (myLayout4.root.contentItems.length > 0) {
                        myLayout4.root.removeChild(glAnalysisToolsColumn,true);
                        toggleFullZoomDisplay();
                    } else {
                        myLayout3.root.removeChild(glAnalysisToolsColumn,true);
                    }
                    glAnalysisToolsColumn.element.hide();
                    glFindPatientsColumn.element.show();
                    myLayout3.root.addChild(glFindPatientsColumn);
                    myLayout3.updateSize();
                    glColumn='FindPatients';
                    newSize();
                    if (glMaximisedItem) {
                        glMaximisedItem.toggleMaximise();
                    }
                    break;
                default:
                    alert("View mode ["+newMode+"] is unknown!");
                    return false;
            }
...
i2b2.hive.MasterView.eventInitView	=  $.Callbacks();
i2b2.hive.MasterView.eventChangeMode =  $.Callbacks();
i2b2.hive.MasterView.eventZoomWindows =  $.Callbacks();
...
i2b2.events.initView.subscribe = (function(a1,a2,a3,a4,a5,a6) {i2b2.hive.MasterView.eventInitView.add.call(i2b2.hive.MasterView.eventInitView, a1,a2,a3,a4,a5,a6); });
i2b2.events.changedViewMode = {};
i2b2.events.changedViewMode.subscribe = (function(a1,a2,a3,a4,a5,a6) {i2b2.hive.MasterView.eventChangeMode.add.call(i2b2.hive.MasterView.eventChangeMode, a1,a2,a3,a4,a5,a6); });
i2b2.events.changedZoomWindows = {};
i2b2.events.changedZoomWindows.subscribe = (function(a1,a2,a3,a4,a5,a6) {i2b2.hive.MasterView.eventChangeMode.add.call(i2b2.hive.MasterView.eventZoomWindows, a1,a2,a3,a4,a5,a6); });
