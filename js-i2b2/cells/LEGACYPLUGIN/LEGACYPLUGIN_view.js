        ...
        i2b2.layout.registerWindowHandler("i2b2.LEGACYPLUGIN.view.main",
            (function (container, scope) {
                ...
                container.on('tab', (tab) => {
                    ...
                    container.on('hide', resetComponentState);
                    container.on('show', maximizePluginComponent);
                    tab.header.parent.on("minimised", minimizeComponent);
                    tab.header.parent.on("maximised", maximizeComponent);
...
i2b2.LEGACYPLUGIN.view.exitInstance = function(container) {
    ...
    triggerClose[0].addEventListener('click', (event) => {
      container.close();
