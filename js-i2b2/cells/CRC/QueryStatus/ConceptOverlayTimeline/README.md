...
| File | Purpose |
|------|---------|
| `ConceptOverlayTimeline.js` | Main visualization module class |
| `ConceptOverlayTimeline.html` | Template for the filter bar controls |
| `ConceptOverlayTimeline.css` | Styles scoped to `.viztype-PATHOGENTIMELINE` |
