...
i2b2.WORK.view.main._generateTvNode = function(title, nodeData, parentNode){
    ...
    switch (nodeData.visual) {
        case "CA":
            ...
            render.icon = i2b2.hive.cfg.urlFramework + 'cells/WORK/assets/sdx_WORK_root.png';
        ...
        case "FA":
            ...
            render.icon = i2b2.hive.cfg.urlFramework + 'cells/WORK/assets/sdx_WORK_folder.png';
            render.iconExp = render.icon;
            renderObj = funcAddWrkNode(render);
